...
fun ServiceProviderRegistrationScreen2(
    ...
    // Handle delete service success
    LaunchedEffect(deleteServiceSuccess) {
        if (deleteServiceSuccess) {
            delay(1000) // Brief delay to show success message

            // Set the result in the saved state handle for deletion
            navController.previousBackStackEntry?.savedStateHandle?.set(
                "service_deletion_result",
                mapOf(
            ...
            viewModel.resetDeleteServiceSuccess()
